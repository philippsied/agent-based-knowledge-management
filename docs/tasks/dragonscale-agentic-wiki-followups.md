...
| **FUP-3** | Decide skill-home for substantive `wiki/` subcommands (`fix-issues`, `handoff`) → **[ADR-0005](../adr/0005-skill-home-open-issues-commands.md)** (proposed: new `wiki-issues` skill) | `decision` `concept` | decision | Wiki PRD §7 / ADR-0001 | P1 | — | ADR-0005 ratified by owner (status → accepted). |
