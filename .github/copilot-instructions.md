...
- `skills/`: 13 skills (`autoresearch`, `canvas`, `defuddle`, `doc-pipeline`, `obsidian-bases`, `obsidian-markdown`, `research-brief`, `save`, `wiki`, `wiki-fold`, `wiki-ingest`, `wiki-lint`, `wiki-query`), each with a `SKILL.md` defining trigger phrases and instructions
