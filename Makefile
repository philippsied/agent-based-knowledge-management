...
help:
	...
	@echo "  make test-release-gate     release lint-gate distribution-scoping guard (2.0.0)"
...
test: test-vault-root test-address test-tiling test-boundary test-terminology test-title-overlap test-lint-orphans test-run-lint test-open-issues test-sync-versions test-wiki-path-safety test-setup-provisioning test-skill-count-ssot test-release-gate
	@echo ""
