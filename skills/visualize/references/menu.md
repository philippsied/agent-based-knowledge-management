...
## Reveal.js Custom Bottom Nav

**MANDATORY when using Reveal.js:** disable the default controls (`Reveal.initialize({ ..., controls: false })`) — the built-in `<` `>` arrow overlays are ugly. Add this minimal bottom nav bar instead:
